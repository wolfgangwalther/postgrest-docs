...
* `moneylog <https://github.com/myfreeweb/moneylog>`_ - accounting web app in Polymer + PostgREST
...
* `postgrest-js <https://github.com/supabase/postgrest-js>`_ - Isomorphic JS client
